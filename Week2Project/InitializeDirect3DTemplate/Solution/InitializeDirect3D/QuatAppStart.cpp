...
void QuatApp::Draw(const GameTimer& gt)
{
	...
	// step6: Bind the sky cube map.  For our demos, we just use one "world" cube map representing the environment
...
//	XMVECTOR q1 = XMQuaternionRotationAxis(XMVectorSet(0.0f, 1.0f, 2.0f, 0.0f), XMConvertToRadians(45.0f));
//	XMVECTOR q2 = XMQuaternionRotationAxis(XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), XMConvertToRadians(-30.0f));
//	XMVECTOR q3 = XMQuaternionRotationAxis(XMVectorSet(1.0f, 0.0f, 0.0f, 0.0f), XMConvertToRadians(60.0f));
//
...
//	mSkullAnimation.Keyframes[1].Scale = XMFLOAT3(0.8f, 0.8f, 0.8f);
...
//	mSkullAnimation.Keyframes[2].Scale = XMFLOAT3(0.2f, 0.2f, 0.2f);
...
//	mSkullAnimation.Keyframes[4].Scale = XMFLOAT3(0.5f, 0.5f, 0.5f);
...
void QuatApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&skullRitem->World,
		XMMatrixScaling(0.4f, 0.4f, 0.4f) * XMMatrixTranslation(0.0f, 1.0f, 0.0f));
